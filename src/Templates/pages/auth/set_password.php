...
<form method="POST" action="/set-password" class="auth-form">
    ...
    <p class="auth-helper">Définissez votre mot de passe pour activer votre compte.</p>
    ...
    <button type="submit" class="btn btn--primary btn--block">Définir le mot de passe</button>
</form>
